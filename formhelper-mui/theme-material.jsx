...
const buttonSizes = {
  small:  { fontSize: '12px', minWidth: '60px',  minHeight: '28px', padding: '6px 12px' },
  medium: { fontSize: '12px', minWidth: '80px',  minHeight: '36px', padding: '8px 16px' },
  large:  { fontSize: '12px', minWidth: '120px', minHeight: '44px', padding: '10px 20px' },
};
...
export const baseThemeOptions = {
  ...
  palette: {
    primary:    { main: color.primary.blue },
    secondary:  { main: color.primary.red },
    background: { default: color.bodyBackGround, paper: color.white },
  },
  zIndex: { appBar: 4000, modal: 4001 },
  root:  { display: 'flex' },
  paper: { marginRight: init.spacing(2) },
  colorSchemes: {
    light: {
      palette: {
        primary:   { main: color.primary.blue },
        secondary: { main: color.primary.red },
        text:      { disabled: color.secondary.almostGrey },
      },
    },
  },
  components: {
    ...
    MuiAccordionDetails: {
      ...
      variants: [
        { props: { variant: 'noborder' }, style: { border: `1px solid ${color.primary.white}` } },
      ],
    },
    MuiAccordionSummary: {
      styleOverrides: {
    ...
    PrivateSwitchBase: {
      styleOverrides: { input: { height: '20px', width: '20px' } },
    },
    MuiTypography: {
    ...
    MuiLink: {
      ...
      variants: [
        { props: { variant: 'regular' }, style: { fontWeight: fontWeights.regular } },
        {
          props: { variant: 'dark' },
          style: {
            color: color.primary.blue,
    ...
    MuiListItemText: {
      styleOverrides: {
        root: ({ ownerState }) => {
          const fw = ownerState.bold ? 700 : ownerState.boldish ? 500 : ownerState.light ? 300 : null;
          return {
