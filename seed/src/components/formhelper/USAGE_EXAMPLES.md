...
### Predefined Patterns
```jsx
import { maskPattern } from '@/components/formhelper';

// Available patterns:
maskPattern.ssn           // '###-##-####'
maskPattern.phone         // '(###) ###-####'
maskPattern.phoneExt      // '(###) ###-#### x####'
maskPattern.creditCard    // '#### #### #### ####'
maskPattern.creditCardExpiry // '##/##'
maskPattern.zipCode       // '#####'
maskPattern.zipCodePlus4  // '#####-####'
maskPattern.date          // '##/##/####'
maskPattern.time          // '##:##'
maskPattern.currency      // '$#,###.##'
maskPattern.percentage    // '##%'
maskPattern.licensePlate  // 'AAA-####'
```
